...
if not st.session_state['authenticated']:
    ...
    pages = [
        st.Page(page_tintuc, title="📰 Tin tức", icon="📰"),
        st.Page(page_dieucam, title="🚫 Các điều cấm", icon="🚫"),
        st.Page(page_nguyco, title="🛡️ Nguy cơ & Biện pháp", icon="🛡️"),
        st.Page(page_congcu, title="🛠️ Công cụ", icon="🛠️"),
        st.Page(page_khancap, title="🚨 Khẩn cấp", icon="🚨"),
        st.Page(page_dangxuat, title="🚪 Đăng xuất", icon="🚪"),
    ]
